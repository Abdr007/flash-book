...
try {
  ...
  await stage("ER reduce-only taker with no position is rejected fail-closed (ReduceOnlyNoPosition)", async () => {
    ...
    // untouched. FLAG_REDUCE_ONLY = 2; ReduceOnlyNoPosition = Anchor Custom(8323)/0x2083.
    ...
    catch (e) { rejected = /0x2083|8323|ReduceOnlyNoPosition/i.test(String(e.message || e) + (e.logs || []).join("")); }
