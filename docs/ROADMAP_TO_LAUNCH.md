...
- **Program changes** (need a devnet deploy + live-re-verify cycle each): 4.5
  (2.2 #315; 4.1 #316; 3.3 disp.; 4.3 #318; **4.4 wired** — OI-crowding surcharge, default-off migration; **2.3 built** — trustless fee-share escrow-accrual, host-tested, devnet cycle pending). (**4.8 CLOSED** + devnet-accepted, PR #300; the H-B cancel-lock
