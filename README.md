...
| Formal verification | **61 Kani proof harnesses** on the deployed risk/settlement paths + **Lean theorems** (haircut conservation, OI/MMR, funding) at the real value domain + Certora property specs (written; prover integration in progress) |
